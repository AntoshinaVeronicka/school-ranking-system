# -*- coding: utf-8 -*-
"""
Применение SQL-оптимизаций для раздела "Поиск школы".

Что делает:
- выполняет db/sql/search_school_optimization.sql;
- создает pg_trgm + GIN индексы для поиска по названию школы.
