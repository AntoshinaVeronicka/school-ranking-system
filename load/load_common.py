# -*- coding: utf-8 -*-
"""
Общие функции для загрузчиков данных.

Содержит нормализацию строк, разрешение путей/листов Excel
и получение конфигурации подключения к PostgreSQL.
"""
...
# Блок сокращений правовой формы (сокращаем только эту часть).
...
def standardize_school_name(name: str) -> str:
    ...
    # Минимальная техническая чистка.
    ...
    # Удаляем хвостовой мусор Excel: "+B116".
    ...
    # Сокращение правовой формы (и только её).
