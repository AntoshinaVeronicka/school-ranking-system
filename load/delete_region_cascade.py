# -*- coding: utf-8 -*-
"""
Каскадная очистка региона и всех связанных данных.

Удаляет регион, школы и зависимые записи в предметных/аналитических
таблицах с учётом ограничений внешних ключей.
"""
