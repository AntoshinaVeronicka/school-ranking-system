# -*- coding: utf-8 -*-
"""
CLI-скрипт для выполнения запросов раздела "Поиск школы" напрямую к PostgreSQL.

Примеры:
    python load/search_school_queries.py options
    python load/search_school_queries.py search --q "лицей" --region-id 2 --year 2024 --kind actual --page 1 --per-page 20
    python load/search_school_queries.py card --school-id 123
"""
