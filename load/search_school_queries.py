# -*- coding: utf-8 -*-
"""
CLI для проверки SQL-запросов раздела «Поиск школы».

Позволяет получить значения фильтров, выполнить поиск
и запросить карточку школы напрямую из PostgreSQL.
"""
