# -*- coding: utf-8 -*-
"""
Загрузка направлений подготовки и требований ЕГЭ из Excel в PostgreSQL.

Что обновляет:
- edu.institute (сидирование при необходимости)
- edu.ege_subject (сидирование при необходимости)
- edu.study_program
- edu.program_ege_requirement

Ожидаемая структура листа (стабильная):
Институт | Код | Направление подготовки | Вступительное испытание 1 |
Вступительное испытание 2 (на выбор) | Вступительное испытание 3

Если во второй колонке ВИ есть конструкция:
Предмет
или
Предмет
то все предметы из этого блока пишутся в role='choice'.
"""
