...
Обновляет справочники институтов/предметов, программы и связи
требований по предметам для каждой программы.
"""
...
def upsert_requirements(
    ...
    for p in programs:
        ...
        def add(subject: Optional[str], role: str, weight: int) -> None:
            ...
            # Если предмет встретился и как required, и как choice,
