...
BEGIN
  IF NOT EXISTS (
    ...
    FROM pg_type t
    JOIN pg_namespace n ON n.oid = t.typnamespace
    WHERE t.typname = 'ege_dataset_kind'
      AND n.nspname = 'edu'
  ) THEN
...
CREATE TABLE edu.analytics_request_filter (
...
CREATE INDEX idx_analytics_request_year ON edu.analytics_request USING btree (year_basis);
